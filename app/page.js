    ...
    <div style={{ fontFamily: '-apple-system, BlinkMacSystemFont, Inter, sans-serif', background: '#fff', color: '#111' }}>
      ...
      <div style={{ padding: '60px 40px', maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          {[
            { label: 'Work authorization', value: 'Authorized to work in the U.S. under F-1 OPT through July 15, 2027. No employer sponsorship required to start.', sub: '' },
      ...
      <div style={{ padding: '80px 40px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 16, color: '#666', marginBottom: 32 }}>
          Physical EAD card received; available to start subject to standard employer onboarding. Let&rsquo;s get on a call this week.
        </p>
